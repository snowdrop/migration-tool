...
- A rule definition encapsulating the information about what to search about within the code source and the instructions to be executed by a provider: user, AI and Openrewrite
