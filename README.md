...
- Provider: A provider is a system able to execute the instructions defined part of a rule where the condition(s) matched. Different could be supported suc h as: Openrewrite recipe, AI or user
