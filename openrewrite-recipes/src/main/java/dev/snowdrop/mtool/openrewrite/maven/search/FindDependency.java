 ...
 */
package dev.snowdrop.mtool.openrewrite.maven.search;

import dev.snowdrop.mtool.openrewrite.maven.table.DependencyReport;
			...
			public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ctx) {
				for (GAV gav : gavList) {
					if (isDependencyTag(gav.groupId, gav.artifactId)
						...
						report.insertRow(ctx, new DependencyReport.Row(matchId, DependencyReport.Type.POM,
