...
/**
 * This interface defines a complete generic visitor for a parse tree produced by {@link QueryParser}.
 *
 * @param <T>
...
public interface QueryVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code OrOperation} labeled alternative in {@link QueryParser#operation}.
	 *
	 * @param ctx
	 *            the parse tree
	 *
	...
	/**
	 * Visit a parse tree produced by the {@code SimpleClause} labeled alternative in {@link QueryParser#operation}.
	 *
	 * @param ctx
	 *            the parse tree
	 *
	...
	/**
	 * Visit a parse tree produced by the {@code AndOperation} labeled alternative in {@link QueryParser#operation}.
	 *
	 * @param ctx
	 *            the parse tree
	 *
