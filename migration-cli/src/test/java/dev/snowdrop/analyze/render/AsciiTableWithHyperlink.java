package dev.snowdrop.analyze.render;
...
public class AsciiTableWithHyperlink {
    ...
    static void main(String[] args) {
        ...
        tableData.add(new String[]{"000-springboot-annotation-notfound", "springboot -> quarkus", "No", "No match found"});
        tableData.add(new String[]{"001-springboot-replace-bom-quarkus","springboot -> quarkus","Yes","Found SpringBootApplication at line 6, char: 1 - 22\nfile:///Users/cmoullia/code/application-modernisation/migration-tool-parent/applications/demo-spring-boot-todo-app/src/main/java/com/todo/app/AppApplication.java"});
        tableData.add(new String[]{"002-springboot-add-class-quarkus","springboot -> quarkus","Yes","Found SpringBootApplication at line 6, char: 1 - 22\nfile:///Users/cmoullia/code/application-modernisation/migration-tool-parent/applications/demo-spring-boot-todo-app/src/main/java/com/todo/app/AppApplication.java"});
        tableData.add(new String[]{"003-springboot-to-quarkusmain-annotation","springboot -> quarkus","Yes","Found SpringBootApplication at line 6, char: 1 - 22\nfile:///Users/cmoullia/code/application-modernisation/migration-tool-parent/applications/demo-spring-boot-todo-app/src/main/java/com/todo/app/AppApplication.java"});
        tableData.add(new String[]{"004-springboot-to-quarkus-rest-annotations","springboot -> quarkus","Yes","Found PostMapping at line 77, char: 5 - 17\nfile:///Users/cmoullia/code/application-modernisation/migration-tool-parent/applications/demo-spring-boot-todo-app/src/main/java/com/todo/app/controller/TaskController.java\n--- rewrite ---\nFound ResponseBody at line 77, char: 5 - 17\nfile:///Users/cmoullia/code/application-modernisation/migration-tool-parent/applications/demo-spring-boot-todo-app/src/main/java/com/todo/app/controller/TaskController.java"});

        System.out.println("\n=== Migration data with Styler ===");
        var asciiTable = AsciiTable.builder().styler(customizeStyle()).data(tableData, Arrays.asList(
