...
public class YamlToJavaParseTest {
    ...
    public void should_parse_yaml_to_java_object() throws IOException {
        ...
        assertEquals("Replace the Spring Boot Application Annotation with QuarkusMain and add Quarkus.run", rule.description());
        ...
        assertEquals("Remove the org.springframework.boot.autoconfigure.SpringBootApplication annotation from the main Spring Boot Application class",
