...
/**
 * Interface for migration providers that handle different types of transformations
 * based on YAML rule instructions (AI, OpenRewrite, Manual).
 */
public interface MigrationProvider {
     ...
     *
     * @param task the migration task containing the rule and instructions
     * @param context the execution context containing project path, settings, etc.
